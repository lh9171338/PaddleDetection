...
import paddle
import tqdm
from lh_ppdet.datasets.transforms import Compose
from lh_ppdet.apis import manager


@manager.DATASETS.add_component
class BoschTrafficLightDataset(paddle.io.Dataset):
    """
...
if __name__ == "__main__":
    ...
    from lh_ppdet.datasets.transforms import (
        LoadImageFromFile,
        LoadLabelFromFile,
        ColorJitter,
